...
var helper = function( context ){
    ...
    if( context._helpers.session )
        ...
        if( !this.id ){
            ...
            this.cookies_helper.set(this.cookiename,this.id,{httponly:true});
        }
...
helper.prototype.set = function(values,next){
    if( !values && typeof(values)!=='object' )
        next( error.new(this.ERROR_INVALID_VALUES,{values:values}) );
    else
...
helper.prototype.getValue = function(name,next){
    if( typeof(name) === 'string' && name!=='' )
        ...
        next( error.new(this.ERROR_INVALID_NAME,{name:name}) );
};
helper.prototype.setValue = function(name,value,next){
    if( !value && ( typeof(value)!=='string' || typeof(value)!=='number' ) )
        next( error.new(this.ERROR_INVALID_VALUE,{value:value}) );
    else
