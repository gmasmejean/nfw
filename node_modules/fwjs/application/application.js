...
var moduleManager = require('../modules/manager.js'),
    ...
    viewManager = require('../../view/manager.js'),
...
application.prototype.controller = controller;
...
application.prototype.configure = function( configuration, next ){
    ...
    var setLocaleConfiguration = function(){
        ...
        util.parallel([
            [this.serviceManager.configure.bind(this),[configuration.services,this.__DIR__]],
            [this.viewManager.configure.bind(this),[configuration.views,this.__DIR__]],
            [this.routeManager.configure.bind(this),[configuration.routing]],
            [this.eventManager.configure.bind(this),[configuration.events]]
        ], next);
