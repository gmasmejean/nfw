...
manager.prototype.ERROR_ADD_NO_NAME = {code:'SMGR_1',message:'Can\'t add service with empty name'};
manager.prototype.ERROR_ADD_INVALID_PATH = {code:'SMGR_2',message:'Can\'t add service, path is invalid'};
manager.prototype.ERROR_ADD_INVALID_SERVICE = {code:'SMGR_3',message:'Can\'t add service, service must be a function or a file path.'};
manager.prototype.ERROR_NOT_EXIST = {code:'SMGR_4',message:'Service does not exist.'};
    ...
    if( services instanceof Object ){        
        for( var name in services ){
            if( services[name] instanceof Object ){                
                var uniq = services[name].unique!==undefined?services[name].unique:true;
