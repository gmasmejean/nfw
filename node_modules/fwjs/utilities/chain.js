...
module.exports = function( fns ){    
    ...
    f = (function(fn, args, ctx ){
        return function(){
            fn.bind(ctx||null).apply(null,(args||[]).concat( Array.prototype.slice.call(arguments,0) , reference.callback ) );
        };
    ...
    for(;l>=0;l--){
        ...
        f = (function( fn, args, ctx, callback ){
            return function(){
                fn.bind( ctx||null ).apply(null,(args||[]).concat( Array.prototype.slice.call(arguments,0) , callback ) );
            };
